...
$recaptcha_secret = '6Lf1ONQZAAAAAEqSalacACLtue8igyGH6XlxwCzb'; 
...
$recipients = 'info@estudiowebmas.es';
//$recipients = '#';
...
//$mail->AddBCC('maq@maqdevelopment.com', 'copia oculta');
...
if($_POST['name']!="" && $_POST['email']!="" && $_POST['telefono']!="" && $_POST['provincia']!="" && $_POST['message']!=""){
    $mail->send();
    die('MF000');
}
